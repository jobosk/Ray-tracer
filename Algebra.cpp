...
Punto::Punto(const Real4& r4):Real4(r4.x(),r4.y(),r4.z(),1)
//Constructor copia
{
}
...
Punto Punto::transform(const Matriz &t)const
...
Vector::Vector(const Real4 &r4):Real4(r4.x(),r4.y(),r4.z(),0)
//Constructor copia
{
}
...
Vector Vector::transform(const Matriz &t)const
//Devuelve el vector premultiplicado por la matriz (cuarta componente es cero)
{
	Vector p;
	for(int i=0;i<3;i++) p.setelem(i,t.row(i)*(*this));
	return p;
}
//Color -----------------------------------
...
Matriz Matriz::inverse3x3() const
{
	//Determinante de la submatriz m[3][3]
	float determinante=	  e[0][0] * (e[1][1] * e[2][2] - e[1][2] * e[2][1])
						- e[0][1] * (e[1][0] * e[2][2] - e[1][2] * e[2][0])
						+ e[0][2] * (e[1][0] * e[2][1] - e[1][1] * e[2][0]);
	Matriz inversa;	//Identidad
	//Inversa por adjuntos
	inversa.setelem( 0,0, + (e[1][1] * e[2][2] - e[1][2] * e[2][1])/determinante );
	inversa.setelem( 0,1, - (e[0][1] * e[2][2] - e[0][2] * e[2][1])/determinante );
	inversa.setelem( 0,2, + (e[0][1] * e[1][2] - e[0][2] * e[1][1])/determinante );
	inversa.setelem( 1,0, - (e[1][0] * e[2][2] - e[1][2] * e[2][0])/determinante );
	inversa.setelem( 1,1, + (e[0][0] * e[2][2] - e[0][2] * e[2][0])/determinante );
	inversa.setelem( 1,2, - (e[0][0] * e[1][2] - e[0][2] * e[1][0])/determinante );
	inversa.setelem( 2,0, + (e[1][0] * e[2][1] - e[1][1] * e[2][0])/determinante );
	inversa.setelem( 2,1, - (e[0][0] * e[2][1] - e[0][1] * e[2][0])/determinante );
	inversa.setelem( 2,2, + (e[0][0] * e[1][1] - e[0][1] * e[1][0])/determinante );
	return	inversa;
}
...
Transformacion::Transformacion(const Matriz &m):Matriz(m)
//Constructor por matriz
{
}
