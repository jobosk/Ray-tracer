...
public:
	...
	Punto(const Real4& r4);							//Constructor por copia
	...
	Punto transform(const Matriz &)const;			//Devuelve el punto transformado
...
public:
	...
	Vector(const Real4& r4);						//Constructor por copia
	...
	Vector transform(const Matriz &)const;			//Devuelve el vector transformado
};
...
public:
	...
	Matriz inverse3x3() const;						//Devuelve la inversa de la submatriz 3x3 (añade 4 fila y columna)
...
public:
	...
	Transformacion(const Matriz &);					//Constructor por matriz
